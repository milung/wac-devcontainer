...
for (const template of templates) {
    ...
    copyFileSync('./dist/index.js', join(templatesRoot, template, toolsFolder, 'rename-pfx.js'))
...
copyFileSync('./dist/index.js', join(prebuildRoot, toolsFolder, 'rename-pfx.js'))
